  ...
  <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        ...
        <a href="{{ url('debit_transaction/create') }}" class="btn btn-primary my-2">
              ...
              @else
                ...
                @for ($i = 0; $i < $categories->count(); $i++)
                  ...
                  <tr>
                    ...
                    <td><a href="{{ url('debit_transaction/'.$categories[$i]->transactions[$j]->id.'/edit') }}">Edit</a></td>
                    <td>
                      <form method="POST" action="{{ url('debit_transaction/'.$categories[$i]->transactions[$j]->id) }}" id="delete-{{ $categories[$i]->transactions[$j]->id }}">
                        {{ csrf_field() }}
                        {{ method_field('DELETE') }}
