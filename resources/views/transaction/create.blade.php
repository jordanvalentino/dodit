...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      ...
      <form class="user" method="POST" action="{{ url('transaction') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
          ...
          <div class="col-sm-6 mb-3 mb-sm-0">
            ...
            <select class="form-control" name="category_id" placeholder="Category" autofocus>
              ...
              <optgroup label="Earnings">
                @foreach ($debits as $index => $parent)
                <option value="{{ $parent->id }}" @if ($index == 0) selected @endif>
                  {{ $parent->name }}
                </option>
              ...
              <optgroup label="Spendings">
                @foreach ($credits as $index => $parent)
        ...
        <div class="form-group">
          <div class="col-sm-6 mb-3 mb-sm-0">
            <input type="number" class="form-control" placeholder="Earned/Spended Amount" name="amount" min=0 value=0 required>
          </div>
        </div>
