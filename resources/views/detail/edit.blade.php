...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      ...
      <form class="user" method="POST" action="{{ url('detail/'.$detail->id) }}">
        {{ csrf_field() }}
        {{ method_field('PUT') }}
        ...
        <div class="form-group">
          <div class="col-sm-6 mb-3 mb-sm-0">
            ...
            <input type="number" class="form-control" placeholder="Amount" name="amount" min=0 value="{{ $detail->amount }}" required>
          </div>
        </div>
